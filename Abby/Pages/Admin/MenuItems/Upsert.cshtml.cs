...
namespace Abby.Pages.Admin.MenuItems
{
    ...
    public class UpsertModel : PageModel
    {
        ...
        public UpsertModel(IUnitOfWork db, IWebHostEnvironment hostEnvironment)
        {
            _unitOfWork = db;
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if (MenuItem.Id == 0)
            {
                ...
                {   string fileName_new = Guid.NewGuid().ToString();
                    ...
                    //should make sure an image is there before this check. 
                    var extension = Path.GetExtension(files[0].FileName);

                    using (FileStream fileStream = new FileStream(Path.Combine(uploads, fileName_new + extension), FileMode.Create))
                    {
                    ...
                    _unitOfWork.Save();
                    TempData["success"] = "Successfully Created a New Menu Item";
                }
            }
            else
            {
                ...
                _unitOfWork.MenuItem.Add(MenuItem);
                _unitOfWork.Save();
                TempData["success"] = "Successfully Updated a New Menu Item";
            }
